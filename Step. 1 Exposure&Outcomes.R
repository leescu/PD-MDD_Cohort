...
{#* section 1.1 NHANES III Periodontitis diagnosis ####
  {#** section 1.1.1 Data Preparation ####
    PD_dia=read.table("I:/paper_8_PD&MDD/data/NHANESIII/exam.dat",sep=",",fill=T)
  ...
  {#** section 1.1.7 data selction age>=30 ####
    ...
    save(PD_III,file="I:/paper_8_PD&MDD/data/PD_III.Rdata")
  }
}
{#* section 1.2 NHANES 1999-2004 Periodontitis diagnosis ####
  {#** section 1.2.1 Data Preparation ####
    #periodontal_data
    OHXPER_9900<-read.xport("I:/paper_8_PD&MDD/data/PD/OHXPERIO.XPT")
    OHXPERL_0102<-read.xport("I:/paper_8_PD&MDD/data/PD/OHXPRL_B.XPT")
    OHXPERU_0102<-read.xport("I:/paper_8_PD&MDD/data/PD/OHXPRU_B.XPT")
    OHXPERL_0304<-read.xport("I:/paper_8_PD&MDD/data/PD/OHXPRL_C.XPT")
    OHXPERU_0304<-read.xport("I:/paper_8_PD&MDD/data/PD/OHXPRU_C.XPT")
  ...
  {#** section 1.2.7 data selction age>=30 ####
    ...
    save(PD_CON1,file="I:/paper_8_PD&MDD/data/PD_CON1.Rdata")
  }
}
{#* section 1.3 NHANES 2009-2014 Periodontitis diagnosis ####
  {#** section 1.3.1 Data Preparation ####
    ...
    setwd("I:/paper_8_PD&MDD/data/PD")
  ...
  {#** section 1.3.8 data selction age>=20 ####
    ...
    save(PD_CON2,file="I:/paper_8_PD&MDD/data/PD_CON2.Rdata")
  }
...
{#* section 2.1 NHANES III Exclusion Data ####
  {#** section 2.1.1 Data Preparation ####
    ...
    exam$CIDIII<-as.numeric(substring(exam$V1,5015,5016))
    MDD_III<-exam[,c("SEQN","CIDIII")]
    MDD_III$CIDIII[MDD_III$CIDIII==88]<-NA
    MDD_III<-subset(MDD_III,!is.na(CIDIII))
    MDD_III$CIDIII_Grade[MDD_III$CIDIII==1]<-0
    #Non-severe major depressive
    MDD_III$CIDIII_Grade[MDD_III$CIDIII==2|MDD_III$CIDIII==5]<-1
    #Severe major depressive
    MDD_III$CIDIII_Grade[MDD_III$CIDIII==3|MDD_III$CIDIII==4]<-2
    MDD_III$CIDIV<-NA
    MDD_III$PHQ9<-NA
    MDD_III$PHQ9_Grade<-NA
    MDD_III$PHQ9_Score<-NA
    MDD_III$MDD[MDD_III$CIDIII_Grade==0]<-0
    MDD_III$MDD[MDD_III$CIDIII_Grade==1|MDD_III$CIDIII_Grade==2]<-1
    table(MDD_III$MDD,useNA = "ifany")
    colnames(MDD_III)
    save(MDD_III,file="I:/paper_8_PD&MDD/data/MDD_III.Rdata")
...
{#* section 2.1 NHANES 1999-2004 Exclusion Data ####
  {#** section 2.1.1 Data Preparation ####
    MDD_9900<-read.xport("I:/paper_8_PD&MDD/data/MDD/CIQMDEP.XPT")
    MDD_0102<-read.xport("I:/paper_8_PD&MDD/data/MDD/CIQDEP_B.XPT")
    MDD_0304<-read.xport("I:/paper_8_PD&MDD/data/MDD/CIQDEP_C.XPT")
    MDD_CON1<-rbind(MDD_9900[,c("SEQN","CIDDSCOR")],
                    MDD_0102[,c("SEQN","CIDDSCOR")],
                    MDD_0304[,c("SEQN","CIDDSCOR")])
    MDD_CON1<-subset(MDD_CON1,!is.na(CIDDSCOR))
    MDD_CON1$CIDIII<-NA
    MDD_CON1$CIDIII_Grade<-NA
    MDD_CON1$CIDIV<-MDD_CON1$CIDDSCOR
    MDD_CON1$CIDDSCOR<-NULL
    MDD_CON1$PHQ9<-NA
    MDD_CON1$PHQ9_Grade<-NA
    MDD_CON1$PHQ9_Score<-NA
    MDD_CON1$MDD[MDD_CON1$CIDIV==5]<-0
    MDD_CON1$MDD[MDD_CON1$CIDIV==1]<-1
    table(MDD_CON1$MDD,useNA = "ifany")
    colnames(MDD_CON1)
    save(MDD_CON1,file="I:/paper_8_PD&MDD/data/MDD_CON1.Rdata")
  }
}
...
{#* section 2.1 NHANES 2009-2014 Exclusion Data ####
  {#** section 2.1.1 Data Preparation ####
    MDD_CON2<-diag_PHQ9(years = 2009:2014,score = TRUE, dpq = TRUE)
    colnames(MDD_CON2)[1]<-"SEQN"
    MDD_CON2<-subset(MDD_CON2,answer>8)
    MDD_CON2$CIDIII<-NA
    MDD_CON2$CIDIII_Grade<-NA
    MDD_CON2$CIDIV<-NA
    table(MDD_CON2$PHQ9,useNA = "ifany")
    MDD_CON2$PHQ9<-as.character(MDD_CON2$PHQ9)
    MDD_CON2$PHQ9_Grade[MDD_CON2$PHQ9=="[0,4]"|MDD_CON2$PHQ9=="[5,9]"]<-0
    MDD_CON2$PHQ9_Grade[MDD_CON2$PHQ9=="[10,14]"]<-1
    MDD_CON2$PHQ9_Grade[MDD_CON2$PHQ9=="[15,19]"]<-2
    MDD_CON2$PHQ9_Grade[MDD_CON2$PHQ9=="[20,27]"]<-3
    MDD_CON2$PHQ9[MDD_CON2$PHQ9_Grade>=1]<-1
    MDD_CON2$PHQ9[MDD_CON2$PHQ9_Grade==0]<-0
    MDD_CON2$PHQ9_Score<-MDD_CON2$score
    table(MDD_CON2$PHQ9,useNA = "ifany")
    MDD_CON2<-MDD_CON2[,c("SEQN","CIDIII","CIDIII_Grade","CIDIV","PHQ9","PHQ9_Grade","PHQ9_Score")]
    MDD_CON2$MDD[MDD_CON2$PHQ9==1]<-1
    MDD_CON2$MDD[MDD_CON2$PHQ9==0]<-0
    colnames(MDD_CON2)
    save(MDD_CON2,file="I:/paper_8_PD&MDD/data/MDD_CON2.Rdata")
  }
}
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
...
save(EX_III,file="I:/paper_8_PD&MDD/data/EX_III.Rdata")
...
save(EX_CON1,file="I:/paper_8_PD&MDD/data/EX_CON1.Rdata")
...
save(EX_CON2,file="I:/paper_8_PD&MDD/data/EX_CON2.Rdata")


# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> Section 4. Periodontal status of DM patients <<<<< ####
load(file="I:/paper_8_PD&MDD/data/MDD_III.Rdata")
load(file="I:/paper_8_PD&MDD/data/MDD_CON1.Rdata")
load(file="I:/paper_8_PD&MDD/data/MDD_CON2.Rdata")
load(file="I:/paper_8_PD&MDD/data/PD_III.Rdata")
load(file="I:/paper_8_PD&MDD/data/PD_CON1.Rdata")
load(file="I:/paper_8_PD&MDD/data/PD_CON2.Rdata")
load(file="I:/paper_8_PD&MDD/data/EX_III.Rdata")
load(file="I:/paper_8_PD&MDD/data/EX_CON1.Rdata")
load(file="I:/paper_8_PD&MDD/data/EX_CON2.Rdata")
multimerge<-function(dat=list(),...){
  if(length(dat)<2)return(as.data.frame(dat))
  mergedat<-dat[[1]]
  dat[[1]]<-NULL
...
III<-multimerge(list(MDD_III,PD_III,EX_III),by="SEQN",all=T)
MDD_patient_III<-subset(III,MDD==1)
MDD_PD_III<-subset(MDD_patient_III,!is.na(PD_diagnosis))
...
CON1<-multimerge(list(MDD_CON1,PD_CON1,EX_CON1),by="SEQN",all=T)
MDD_patient_CON1<-subset(CON1,MDD==1)
MDD_PD_CON1<-subset(MDD_patient_CON1,!is.na(PD_diagnosis))
multimerge<-function(dat=list(),...){
  if(length(dat)<2)return(as.data.frame(dat))
  mergedat<-dat[[1]]
  dat[[1]]<-NULL
...
CON2<-multimerge(list(MDD_CON2,PD_CON2,EX_CON2),by="SEQN",all=T)
MDD_patient_CON2<-subset(CON2,MDD==1)
MDD_PD_CON2<-subset(MDD_patient_CON2,!is.na(PD_diagnosis))
MDD_PD<-rbind(MDD_PD_III,MDD_PD_CON1,MDD_PD_CON2)
MDD_PD_all<-subset(MDD_PD,Pregnancy=="NO")
MDD_PD_all$Pregnancy<-NULL
save(MDD_PD_all,file="I:/paper_8_PD&MDD/data/MDD_PD_all.Rdata")
save(MDD_PD_III,file="I:/paper_8_PD&MDD/data/MDD_PD_III.Rdata")
save(MDD_PD_CON1,file="I:/paper_8_PD&MDD/data/MDD_PD_CON1.Rdata")
save(MDD_PD_CON2,file="I:/paper_8_PD&MDD/data/MDD_PD_CON2.Rdata")
record<-ls()
rm(list=record[which(record!='MDD_PD_all')])
...
save(MORT_III,file="I:/paper_8_PD&MDD/data/MORT_III.Rdata")
save(MORT_CON1,file="I:/paper_8_PD&MDD/data/MORT_CON1.Rdata")
save(MORT_CON2,file="I:/paper_8_PD&MDD/data/MORT_CON2.Rdata")
# ++++++++++++++++++++++++++++++++++++++++++++++++++++++ ####
# >>>>> Section 6. Combine of PD & DM & Mortality <<<<< ####
{#* section 6.1 NHANES III Combine of data ####
  load(file="I:/paper_8_PD&MDD/data/MDD_PD_III.Rdata")
  load(file="I:/paper_8_PD&MDD/data//MORT_III.Rdata")
  III_base_mo_stat<-merge(MDD_PD_III,MORT_III,by = "SEQN",all= F)
...
{#* section 6.2 NHANES 1999-2004 Combine of data ####
  load(file="I:/paper_8_PD&MDD/data/MDD_PD_CON1.Rdata")
  load(file="I:/paper_8_PD&MDD/data/MORT_CON1.Rdata")
  CON1_base_mo_stat<-merge(MDD_PD_CON1,MORT_CON1,by = "SEQN",all.x = T)
...
{#* section 6.3 NHANES 2009-2014 Combine of data ####
  load(file="I:/paper_8_PD&MDD/data/MDD_PD_CON2.Rdata")
  load(file="I:/paper_8_PD&MDD/data/MORT_CON2.Rdata")
  CON2_base_mo_stat<-merge(MDD_PD_CON2,MORT_CON2,by = "SEQN",all.x = T)
...
save(III_baseline,file="I:/paper_8_PD&MDD/data/III_baseline.Rdata")
save(CON1_baseline,file="I:/paper_8_PD&MDD/data/CON1_baseline.Rdata")
save(CON2_baseline,file="I:/paper_8_PD&MDD/data/CON2_baseline.Rdata")
